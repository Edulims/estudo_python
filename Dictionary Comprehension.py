...
numeros = [1, 2, 3, 4, 5]
# Nesse caso apenas pego os valores da lista e elevo ao quadrado. Lista
# quadrado = [valor ** 2 for valor in numeros]

# Nesse caso eu pego valor defino como chave, pego o valor e elevo ao quadrado. Dicionario
